<div id="home">
	...
	<div class="row-fluid" id="about">
		...
		<div id="skills">
			...
			<p>"Management is efficiency in climbing the ladder of success; leadership determines whether the ladder is leaning against the right wall." (Covey, R. Stephen). One of the things I always emphasize about leadership is to <span>share the knowledge;</span> "try to lead by <span>making leaders</span> not followers". When managing a project I manage people to work as a team, deliver in time and feel accomplished to keep <span>motivation.</span></p>

			<div class="alt">
				<h3>UX Front end and Back end Developer</h3>
				<p>There is always a programmable <span>solution</span> to your problems. I don't start programming straight away, first there is always a need to analyze to determine the best solution possible fitting all your needs no more, no less. I have experience developing in <a href="http://www.php.net/">PHP</a> (<a href="http://cakephp.org/">CakePHP</a>), CSS3 (<a href="http://sass-lang.com/">Sass</a> and <a href="http://lesscss.org/">Less</a> - like <a href="http://twitter.github.com/bootstrap/">Twitter Bootstrap</a>), <a href="http://www.w3.org/html/logo/#top">HTML5</a> and <a href="http://jquery.com/">jQuery</a>; and everyday I try to learn something new always keeping up to day with the fast evolving technologies.</p>
			</div>
		</div>
	</div>
	...
	<div class="row-fluid">
		...
		<div class="span5 passion metro traveling">
			...
			<h3>Traveling</h3>
			<p>I grew up in many <span>different countries</span>, all with very different <span>cultural backgrounds</span>. Having this opportunity gave me the ability to <span>adapt to new situations naturally</span>. For similar reason I am always keen to travel and independent.</p>
		</div>
		<div class="span5 passion metro cooking">
			<i class="icon-food"></i>
			<h3>Cooking</h3>
